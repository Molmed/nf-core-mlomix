...
include { CLASS_REPORTER         } from '../modules/local/gexml/class_reporter/class_reporter'
include { CONCATENATE_GEX        } from '../modules/local/gexml/concatenate_gex'
include { UMAP as UMAP_RAW_BY_BATCH  } from '../modules/local/gexml/umap/umap'
include { UMAP as UMAP_BC_BY_BATCH   } from '../modules/local/gexml/umap/umap'
include { UMAP as UMAP_NORM_BY_BATCH } from '../modules/local/gexml/umap/umap'
include { UMAP as UMAP_RAW_BY_CLASS  } from '../modules/local/gexml/umap/umap'
include { UMAP as UMAP_BC_BY_CLASS   } from '../modules/local/gexml/umap/umap'
include { UMAP as UMAP_NORM_BY_CLASS } from '../modules/local/gexml/umap/umap'
include { BATCH_CORRECT          } from '../modules/local/gexml/batch_correct'
include { FILTER_GENES           } from '../modules/local/gexml/filter_genes/filter_genes'
include { MERGE_DATASETS         } from '../modules/local/gexml/merge_datasets'
include { NORMALIZE              } from '../modules/local/gexml/normalize'
include { TRANSPOSE              } from '../modules/local/gexml/transpose'
